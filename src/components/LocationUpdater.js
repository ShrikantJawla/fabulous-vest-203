...
function LocationUpdater() {
    ...
    return (
        <VStack zIndex='8989989' bg='white' rounded={5} spacing={5} boxShadow={shadow} position='fixed' top={{base:'5%',lg:'10%'}} left={{base:'4%',md:'25%',lg:'38%'}} px='7' py='9' w={{base:'90vw',md:'360px'}} h='fit-content'>
            <FormControl>
